...
var querystring_json_1 = require("@/schemas/querystring.json");
var headers_json_1 = require("@/schemas/headers.json");
...
server.route({
    ...
    preHandler: function (request, reply, done) {
        var _a = request.query, username = _a.username, password = _a.password;
        var customerHeader = request.headers['h-Custom'];
        done();
    },
    handler: function (request, reply) {
        var _a = request.query, username = _a.username, password = _a.password;
        var customerHeader = request.headers['h-Custom'];
        reply.status(200).send({ username: username });
    }
});
